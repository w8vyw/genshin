...
const isProd = process.env.NODE_ENV === 'prod', isDev = !isProd
...
const appShortName = 'Name' // short_name
const appDescription = 'Description' // description
const appBackground = '#fff' // background_color
const appThemeColor = '#fff' // theme_color
            ...
            options: {
              postcssOptions: {
                plugins: [
                  ...
                  isGroupingMediaQueries ? require('mqpacker') : undefined,
                ],
              },
            },
          },
  ...
  optimization: {
    minimizer: [
      new ImageMinimizerWebpackPlugin({
        minimizer: {
          implementation: ImageMinimizerWebpackPlugin.imageminMinify, options: {
            plugins: [
      ...
      new FileManagerWebpackPlugin({
        events: {
          onEnd: {
            copy: [{source: './static/**', destination: path.resolve(__dirname, 'dist')}],
          },
        },
      }),
    ],
